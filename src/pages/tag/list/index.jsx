                            ...
                            tagList.map(item => {
                                return (
                                    <View className='tag-item' key={item.id}>
                                        ...
                                        {
                                            item.id !== 'all' && <Image className='edit-icon' src={editIconUrl} onClick={() => this.editTag(item)} />
                                        }
                                        {
                                            item.id !== 'all' && <Image className='delete-icon' src={deleteIconUrl} onClick={() => this.deleteTag(item)} />
                                        }
                                    </View>
                                )
                            })
